...
window.onload = function () {
  ...
  if (skillOrigemElement) {
    ...
    switch (skillOrigem) {
      case "25166189":
        skillFormatada = "25166189 - Coopcerto Retencao";
        break;
      case "25166188":
        skillFormatada = "25166188 - Coopcerto Empresa";
        break;
      case "25166187":
      ...
      case "25166175":
        ...
        break;
      case "25166306":
        skillFormatada = "25166306 - TER Coopcerto Portador Emergencial";
        break;
      default:
        skillFormatada = " ";
        break;
...
function showPopup() {
  ...
  if (opTransf != "") {
    ...
    switch (opTransf) {
      case "25166189":
        transfSkill = "25166189 - Coopcerto Retencao";
        break;
      case "25166188":
        transfSkill = "25166188 - Coopcerto Empresa";
        break;
      case "25166187":
